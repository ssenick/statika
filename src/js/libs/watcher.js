...
import { svgAnimation } from '../files/script.js';
  ...
  scrollWatcherIntersecting(entry, targetElement) {
    if (entry.isIntersecting) {
      ...
      if (!targetElement.classList.contains('_watcher-view')) {
        ...
        targetElement.closest('#about-us') ? svgAnimation('#about-us') : null;
        targetElement.closest('#servises') ? svgAnimation('#servises') : null;
        targetElement.closest('#referencie') ? svgAnimation('#referencie') : null;
      }
